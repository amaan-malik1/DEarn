...
export type WorkerWhereInput = {
    ...
    pending_amount?: Prisma.IntFilter<"Worker"> | number;
    locked_amount?: Prisma.IntFilter<"Worker"> | number;
...
export type WorkerScalarWhereWithAggregatesInput = {
    ...
    pending_amount?: Prisma.IntWithAggregatesFilter<"Worker"> | number;
    locked_amount?: Prisma.IntWithAggregatesFilter<"Worker"> | number;
};
...
export type WorkerOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "address" | "pending_amount" | "locked_amount", ExtArgs["result"]["worker"]>;
...
export interface WorkerFieldRefs {
    ...
    readonly pending_amount: Prisma.FieldRef<"Worker", 'Int'>;
    readonly locked_amount: Prisma.FieldRef<"Worker", 'Int'>;
}
/**
 * Worker findUnique
 */
